node {
            ...
            dir("${env.WorkSpace}") {
                ...
                try{           
                    ...
                    checkout([$class: 'GitSCM', branches: [[name: 'refs/heads/Demo']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '56506a35-9c43-4e38-acf6-96cc65436690', url: 'https://github.com/rjkumar1536/Demo.git']]])
